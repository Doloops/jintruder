...
public class NamedThreadFactory implements ThreadFactory
{
    ...
    public NamedThreadFactory(String threadNamePrefix)
    {
        ...
        this.threadNamePrefix = String.format(Locale.ROOT, NAME_PATTERN, checkPrefix(threadNamePrefix),
    ...
    public Thread newThread(Runnable r)
    {
        final Thread t = new Thread(group, r,
                String.format(Locale.ROOT, "%s-%d", this.threadNamePrefix, threadNumber.getAndIncrement()), 0);
        t.setDaemon(false);
